...
class Caesar_3_Page extends StatefulWidget {
  @override
  _Caesar_3_PageState createState() => _Caesar_3_PageState();
}

class _Caesar_3_PageState extends State<Caesar_3_Page> {
  ...
  void _checkText() {
    ...
    if (inputText == 'goodluck') {
      Navigator.pushReplacementNamed(context, '/caesar');
    }
  }
