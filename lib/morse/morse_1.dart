...
class Morse_1_Page extends StatefulWidget {
  @override
  _Morse_1_PageState createState() => _Morse_1_PageState();
}

class _Morse_1_PageState extends State<Morse_1_Page> {
  ...
  void _checkText() {
    ...
    if (inputText == 'hello') {
      Navigator.pushReplacementNamed(context, '/morse_2');
    }
  }
